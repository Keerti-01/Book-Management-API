...
/**
 * route                /book-language/:lang
 * description          get specific book based on language
 * access               public
 * parameter            language
 * methods              get
 */
//http://localhost:8000/book-language/en
 app.get("/book-language/:lang",async (req,res) => {  
    
    const {lang} = req.params;  //destructuring or const isbn = req.params.isbn;
    
    const getSpecificBook = await bookModel.find({language : lang});
...
//http://localhost:8000/book-category/fiction
...
//GET a list ofbooks based on author
/**
 ...
 * methods              get
 */
 //http://localhost:8000/book-author/1
 app.get("/book-author/:id",async (req,res) => {
    let {id} = req.params;
    id = Number(id);
     
    const getAuthorBooks = await bookModel.find({authors : id});

    if(getAuthorBooks.length===0){
        return res.json({"error" : `No books found for the author of ${id}`});
    }
 ...
 * methods              get
 */
//http://localhost:8000/authors-isbn/12345ONE
 ...
 * methods              get
 */
//http://localhost:8000/publications-id/1
 ...
 * methods              get
 */
//http://localhost:8000/publications-isbn/12345Two
 ...
 * methods              post
 */
//http://localhost:8000/addpublication
 ...
 * methods              put
 */
//http://localhost:8000/book-update/12345ONE
 ...
 * methods              delete
 */
//http://localhost:8000/book-delete/12345ONE
 ...
 * methods              delete
 */
//http://localhost:8000/publication-delete-book/1/12345ONE
